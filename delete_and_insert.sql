-- ================================================
-- OPTION 1: Check what business you already have
-- ================================================
SELECT id, name, category FROM businesses WHERE owner_id = '7025eae3-8618-4680-b956-5992d07b5ae9';

-- ================================================
-- OPTION 2: Delete existing and start fresh
-- (Run this if you want to replace with mock businesses)
-- ================================================
DELETE FROM businesses WHERE owner_id = '7025eae3-8618-4680-b956-5992d07b5ae9';

-- Then insert the 3 mock businesses
...
WHERE b.owner_id = '7025eae3-8618-4680-b956-5992d07b5ae9'
